% custom_pop_readneurone_tue_noeloc() - A function for reading NeurOne data without pop-up windows and no elec locations.
% see custom_readneurone_tue_noeloc(), remember that channel labels are set
% 
...
function [EEG,command] = custom_pop_readneurone_tue_noeloc(dataPath,sessionPhaseNumber,chans)
...
% Read data using direct command
    ...
    EEG = custom_readneurone_tue_noeloc(SETTINGS.dataPath,SETTINGS.sessionPhaseNumber, ...
        SETTINGS.chans);
