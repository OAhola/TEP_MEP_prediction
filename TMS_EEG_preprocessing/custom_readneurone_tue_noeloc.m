% custom_readneurone_tue_noeloc()  -  Read data from a Mega NeurOne device and arrange it
%                   into a struct.
% without pop-up windows and no elec locations. NEURONE.chanlocs =
% pop_chanedit(chanlocs); commented out and 
%  switched to with NEURONE.chanlocs = chanlocs; is set
%
% 
%
...
% ========================================================================
% 
% Current version: 1.0.3.5 (2018-11-20)
% Author: Mega Electronics


function NEURONE = custom_readneurone_tue_noeloc(dataPath, varargin)
...
NEURONE.etc = struct('NeurOneVersion', protocol.TableInfo.NeurOneVersion, ...
    'ProtocolFileRevision', protocol.TableInfo.Revision, ...
    'SessionFileRevision', session.TableInfo.Revision);
